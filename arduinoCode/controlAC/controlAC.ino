...
//    Serial.print("url  ");Serial.println(url);
    ...
    const size_t bufferSize = JSON_ARRAY_SIZE(1) + JSON_OBJECT_SIZE(2) + 6000;
    ...
    JsonArray& JSONcoder = jsonBuffer.parseArray(http.getString());       // Parsing
     ...
     Serial.print("jsonCommand[");Serial.print(buffSize);Serial.print("] :"); Serial.println(jsonCommand);
...
void httpGet(){
    HTTPClient http;  //Object of class HTTPClient
    http.begin(IP + "/control/remote_ac/button");
    int httpCode = http.GET();                                             
    if(httpCode > 0){   //Check the returning code    
